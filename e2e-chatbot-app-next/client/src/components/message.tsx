                ...
                return (
                  <div key={key}>
                    <MessageContent
                      ...
                      className={cn({
                        'w-fit break-words rounded-2xl border border-white/[0.08] bg-white/[0.06] px-4 py-3 text-left text-[15px] text-white/88 shadow-[0_10px_30px_rgba(0,0,0,0.18)]':
                          message.role === 'user',
  ...
  return (
    ...
    >
      <div className="flex items-start justify-start gap-3">
        <Shimmer className="flex items-center text-white/50">Thinking</Shimmer>
      </div>
    </div>
  );
};
