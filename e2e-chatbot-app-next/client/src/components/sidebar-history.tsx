      ...
      <SidebarGroup>
        <SidebarGroupContent>
          <div className="flex w-full flex-row items-center justify-center gap-2 px-2 text-sm text-zinc-500">
            Sign in to preserve your memory threads.
          </div>
        </SidebarGroupContent>
      </SidebarGroup>
    );
      ...
      <SidebarGroup>
        <SidebarGroupContent>
          <div className="flex w-full flex-row items-center justify-center gap-2 px-2 text-sm text-muted-foreground">
            {chatHistoryEnabled
              ? 'Saved threads will gather here as you build your vault.'
              : 'History is disabled, so threads are not being saved.'}
          </div>
        </SidebarGroupContent>
      </SidebarGroup>
    );
        ...
        <SidebarGroupContent>
          ...
          {hasReachedEnd ? (
            <div className="mt-8 flex w-full flex-row items-center justify-center gap-2 px-2 text-sm text-zinc-500">
              You have reached the end of your saved threads.
            </div>
          ) : (
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. It will permanently remove the thread from local storage.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
